...
for a in `seq 1 $rnd_scens`; do
   ...
   arr[1]="experiments_mid_low/fsm/"`java -jar selectConfig.jar ./experiments_mid_low/fsm/configurations_fsm_15.txt 8`".txt"
   arr[2]="experiments_mid_low/fsm/"`java -jar selectConfig.jar ./experiments_mid_low/fsm/configurations_fsm_15.txt 16`".txt"
