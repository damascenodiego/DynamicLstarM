...
//			list_of_list_of_suls.add(Experiments.TCP_SRV_IMPLEM_load());
	...
	protected static void setupEQOracle() {
		...
		eqOracle = new RandomWMethodEQOracle<>(oracleForEQoracle, 2, 5, 20000,rnd_seed,1);
		logger.logEvent("EquivalenceOracle: RandomWMethodEQOracle(2, 5, 20000,"+long_seed+",1)");
