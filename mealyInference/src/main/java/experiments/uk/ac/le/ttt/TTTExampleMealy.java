package experiments.uk.ac.le.ttt;
...
public class TTTExampleMealy {
	...
	private static List<Word> listOfCExs;
	...
	public static void main(String[] args) {
		...
		try {
			...
			EquivalenceOracle eqOracle = new SampleSetEQOracle<>(false);
			((SampleSetEQOracle)eqOracle).addAll(oracleForEQoracle, listOfCExs);
	...
	private static CompactMealy<String, String> createWipeSystemMealyMachine() {
		...
		listOfCExs = new ArrayList<>();
		listOfCExs.add(Word.epsilon().append("switchIntv").append("rain").append("rain").append("rain").append("switchPerm"));
		listOfCExs.add(Word.epsilon().append("switchIntv").append("switchIntv").append("rain"));
		listOfCExs.add(Word.epsilon().append("switchPerm").append("rain").append("switchPerm").append("rain").append("rain"));
