...
arr=("experiments_best/fsm/fsm_15_2.txt" "experiments_best/fsm/fsm_15_8.txt" "experiments_best/fsm/fsm_15_16.txt");

rm ./log4j/*.log
rm ./experiments_best/fsm/fsm_*.ot
rm ./experiments_best/fsm/fsm_*.sul
rm ./experiments_best/fsm/fsm_*.infer
rm ./experiments_best/fsm/fsm_*.final
rm ./experiments_best/fsm/fsm_*.reval

logdir=log_experiments_best$(date +"%Y%m%d_%H%M%S_%N")
...
mkdir $logdir/
mv ./log4j $logdir/
mv ./experiments_best/fsm/fsm_*.ot  $logdir/
mv ./experiments_best/fsm/fsm_*.sul  $logdir/
mv ./experiments_best/fsm/fsm_*.infer  $logdir/
mv ./experiments_best/fsm/fsm_*.final  $logdir/
mv ./experiments_best/fsm/fsm_*.reval  $logdir/