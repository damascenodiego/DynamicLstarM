...
rm ./log4j/*.log
rm ./experiments_mid/fsm/fsm_*.ot
rm ./experiments_mid/fsm/fsm_*.sul
rm ./experiments_mid/fsm/fsm_*.infer
rm ./experiments_mid/fsm/fsm_*.final
rm ./experiments_mid/fsm/fsm_*.reval
...
mkdir $logdir/
mv ./log4j $logdir/
mv ./experiments_mid/fsm/fsm_*.ot  $logdir/
mv ./experiments_mid/fsm/fsm_*.sul  $logdir/
mv ./experiments_mid/fsm/fsm_*.infer  $logdir/
mv ./experiments_mid/fsm/fsm_*.final  $logdir/
mv ./experiments_mid/fsm/fsm_*.reval  $logdir/